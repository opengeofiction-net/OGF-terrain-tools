...
SUBSTITUTIONS = [
    ...
    ("dmca.openstreetmap.org",      "wiki.opengeofiction.net/index.php/OpenGeofiction:Contact"),
    ("wiki.openstreetmap.org",      "wiki.opengeofiction.net"),
    ("community.openstreetmap.org", "community.opengeofiction.net"),
    ("blog.openstreetmap.org",      "blog.opengeofiction.net"),
    ("blogs.openstreetmap.org",     "blogs.opengeofiction.net"),
    ("lists.openstreetmap.org",     "lists.opengeofiction.net"),
    ("irc.openstreetmap.org",       "irc.opengeofiction.net"),
    ("welcome.openstreetmap.org",   "welcome.opengeofiction.net"),
